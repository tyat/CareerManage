            ...
            <div id="allemp-stu">
                ...
                <table  class="pure-table pure-table-bordered" style="text-align:left">
                    ...
                    <tr>
                        ...
                        <td width="80px">班级：</td>
                        <td><a href="EmpSearch.html">${list.sgrade}</a></td>
                        <td width="60px">年级：</td>
                        <td width="120px"><a href="EmpSearch.html">${list.sclass}</a></td>
                        <td width="60px">性别：</td>
                    ...
                    <tr>
                        <td >就业企业：</td>
                        <td colspan="5"><button class="mybutton" type="button" onclick="selectCompByCid(${list.cid})">${list.cname}</button></td>
                    </tr>
                    <tr>
                        <td>岗位:</td>
                        <td colspan="5">
                    ...
                    <tr>
                        <td>实习日期：</td>
                        <td colspan="2">2016-10-10</td>
                        <td>实习补贴：</td>
                        <td colspan="2">${list.esalary}元/月</td>
                        <td rowspan="4">
                            <input class="mybutton" type="button" onclick="AreYouSouremp(${list.eid})" value="删除"/>
                        </td>
                    </tr>
                    <tr>
                        <td>离职日期：</td>
                        <td colspan="2">2017-12-02</td>
                        <td>离职原因：</td>
